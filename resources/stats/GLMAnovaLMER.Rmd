...
You don't want the model to predict numbers outside the possible range of the actual data (in this case [0, 1]).
...
For count data you don't want e.g. negative numbers
...
Poisson model assumption: mean = variance
